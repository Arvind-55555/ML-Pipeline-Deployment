...
@cli.command()
@click.option(
    "--config", default="configs/local_pipeline.yaml", help="Pipeline config file"
)
...
def full_deploy(config):
    ...
    click.echo("🎉 Complete! Model serving at: http://127.0.0.1:8000")
    click.echo("🌐 Open your browser to: http://127.0.0.1:8000")
    click.echo("   - Web UI: http://127.0.0.1:8000")
    click.echo("   - API: http://127.0.0.1:8000/predict")
